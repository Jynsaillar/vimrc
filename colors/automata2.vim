  ...
  let s:guishade0 = "#dad4bb"
  let s:guishade1 = "#cac4ad"
  let s:guishade2 = "#b9b49f"
  let s:guishade3 = "#a9a491"
  let s:guishade4 = "#999482"
  let s:guishade5 = "#898474"
  let s:guishade6 = "#787466"
  let s:guishade7 = "#686458"
  let s:guiaccent0 = "#cd664d"
  let s:guiaccent1 = "#b4af9a"
  let s:guiaccent2 = "#3ba99f"
  let s:guiaccent3 = "#727b59"
  let s:guiaccent4 = "#4e4c43"
  let s:guiaccent5 = "#5e6666"
  let s:guiaccent6 = "#b26f5f"
  let s:guiaccent7 = "#50403c"
  let s:ctermshade0 = 15
  let s:ctermshade1 = 14
  let s:ctermshade2 = 249
  let s:ctermshade3 = 247
  let s:ctermshade4 = 246
  let s:ctermshade5 = 244
  let s:ctermshade6 = 242
  let s:ctermshade7 = 241
  let s:ctermaccent0 = 0
  let s:ctermaccent1 = 248
  let s:ctermaccent2 = 73
  let s:ctermaccent3 = 242
  let s:ctermaccent4 = 239
  let s:ctermaccent5 = 241
  let s:ctermaccent6 = 138
  let s:ctermaccent7 = 238
